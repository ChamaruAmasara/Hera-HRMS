...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Leave Application</span>
    ...
    <div class="card-header pt-7">
		<!--begin::Title-->
        <h3 class="card-title align-item-start flex-column">
            <span class="card-label fw-bold text-gray-800">Users(38)</span>
        </h3>
		<!--end::Title-->
		<!--begin::Toolbar-->
			...
			<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
				...
				<thead>
					<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
						<th class="p-0 pb-3 min-w-175px text-start">ITEMS & DESCRIPTIONS</th>
						<th class="p-0 pb-3 min-w-100px text-end">Absent From</th>
						<th class="p-0 pb-3 min-w-100px text-end">Job Title</th>
						<th class="p-0 pb-3 min-w-175px text-end pe-12">PayGrade</th>
						<th class="p-0 pb-3 w-125px text-end pe-7">Department</th>
