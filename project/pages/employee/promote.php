...
if (isset($_POST["submit"])) { 
    ...
    if ($_POST["submit"]=="promoteEmployee"){

        // load the leave application class
        require_once(PROJECT_ROOT_PATH ."/includes/classes/promoteUsers.php");

        //$addEmployee = new PromoteUsers();
												...
												<div class="card-body border-top p-9">
                                                    ...
                                                    <div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<select id="kt_docs_select2_rich_content" name="User" aria-label="Select a User to Promote..." data-placeholder="Select a User to Promote..." class="form-select form-select-solid form-select-lg" required>
