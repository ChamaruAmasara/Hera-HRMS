										...
										<!--begin::Content-->
											...
											<form id="kt_account_profile_details_form" class="form">
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<input type="text" name="oname" class="form-control form-control-lg form-control-solid" placeholder="Organization Name"  />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
												...
												<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input type="text" name="telephone" class="form-control form-control-lg form-control-solid" placeholder="Emergancy Contact Number"  />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input type="text" name="regno" class="form-control form-control-lg form-control-solid" placeholder="Registration Number"  />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
