										...
										<!--begin::Content-->
											...
											<form id="kt_account_profile_details_form" class="form">
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Email Address"  />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
												...
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row">
														<div class="position-relative d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<input class="form-control form-control-solid ps-12" name="date" placeholder="Pick a date" id="kt_datepicker_2" />
														</div>
													</div>
													<!--begin::Col-->
												</div>
												...
												<div class="card-footer d-flex justify-content-end py-6 px-9">
													<button type="reset" class="btn btn-light btn-active-light-primary me-2">Reject</button>
													<button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Approve</button>
												</div>
												<!--end::Actions-->
											</form>
											<!--end::Form-->
