<?php
	...
	$errors = array('DepartmentName'=>'');
	$values = array('DepartmentName'=>'');
    ...
    if (isset($_POST['delSubmit'])) {
        $sqlDel = "DELETE FROM department WHERE DepartmentID = '".$_POST['delete']."';";
...
if (isset($_POST['save'])) {
        ...
        if (isset($_POST['DepartmentName']) and !empty($_POST['DepartmentName']) and $values['DepartmentName'] != $_POST['DepartmentName']) {
            $values['DepartmentName'] = mysqli_real_escape_string($mysqli, $_POST['DepartmentName']);
            $validData =1;
        } else {
            $errors[$key] = "Please enter a valid DepartmentName";
        }

    if ($validData) {
        $sqlSetVal = "INSERT INTO hera.department (DepartmentName) VALUES ('" . $values["DepartmentName"] ."');";
        $resSetVal = $mysqli->query($sqlSetVal);
    }

}
    $rowDept = "SELECT * FROM department;";
											...
											<form id="addDept" method="POST" action="" class="form">
												...
												<div class="card-body border-top p-9">
                                                        ...
                                                        while($rowDept = $resDept->fetch_assoc()){ 
                                                            ...
                                                            <div class="row mb-7">
                                                                ...
                                                                <div class="col-lg-8 fv-row">
                                                                    <span class="fw-semibold text-gray-800 fs-6"><?php echo $rowDept['DepartmentName']; ?></span>
                                                                </div>
                                                                <!--end::Col-->
                                                                <div class="col-lg-8 fv-row">
                                                                    
                                                                        <input name="delete" type="hidden" value="<?php echo $rowDept["DepartmentID"] ?>" >
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input type="text" name="DepartmentName" maxlength="1024" class="form-control form-control-lg form-control-solid" placeholder="Department Name"  />
														<!-- error messege -->
